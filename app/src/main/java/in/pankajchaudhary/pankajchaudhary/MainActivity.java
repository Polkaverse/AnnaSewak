...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent ip= new Intent(MainActivity.this,QueryActivity.class);
                startActivity(ip);
            }
        });
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ip= new Intent(MainActivity.this,MarketActivity.class);
                startActivity(ip);
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_about) {
            ...
            Intent ip= new Intent(this,AboutActivity.class);
            startActivity(ip);
            ...
            //Toast.makeText(this, "efrf",Toast.LENGTH_LONG).show();
            Intent ip= new Intent(this,teamActivity.class);
            startActivity(ip);

        } else if (id == R.id.nav_send) {
            Intent ip= new Intent(this,QueryActivity.class);
            startActivity(ip);
        }
